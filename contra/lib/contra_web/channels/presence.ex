defmodule ContraWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Contra.MyChannel do
        use ContraWeb, :channel
        alias Contra.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :contra,
                        pubsub_server: Contra.PubSub
end
